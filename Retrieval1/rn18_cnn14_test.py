...
def get_args():
    ...
    # Point this to your fully trained baseline weights
    parser.add_argument("--model_path", type=str, default="best_baseline_model.pth")
...
def main():
    ...
    if os.path.exists(args.model_path):
        ...
        print("Please run train_baseline.py first to generate the model.")
        sys.exit()
