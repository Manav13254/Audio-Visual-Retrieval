...
def get_args():
    ...
    parser.add_argument("--model_path", type=str, default="best_sarci_mim.pth")
...
# ==========================================
# ARCHITECTURES (Must match train_sarci_mim.py)
# ==========================================
...
def main():
    ...
    if os.path.exists(args.model_path):
        ...
        print("Please run train_sarci_mim.py first to generate the model.")
        sys.exit()
    ...
    with torch.no_grad():
        for imgs, lbls in tqdm(v_loader, desc="Extracting Vision Features"):
            # Note: reconstruct=False bypasses the PixelDecoder during evaluation
